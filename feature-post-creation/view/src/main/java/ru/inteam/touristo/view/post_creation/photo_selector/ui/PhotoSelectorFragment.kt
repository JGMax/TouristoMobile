package ru.inteam.touristo.view.post_creation.photo_selector.ui
...
import ru.inteam.touristo.presentation.post_creation.photo_selector.store.PhotoSelectorAction
import ru.inteam.touristo.presentation.post_creation.photo_selector.store.PhotoSelectorStore
import ru.inteam.touristo.presentation.post_creation.photo_selector.store.PhotoSelectorStoreFactory
import ru.inteam.touristo.presentation.post_creation.photo_selector.store.PhotoSelectorUiEvent.*
import ru.inteam.touristo.presentation.post_creation.root.store.PostCreationStore
import ru.inteam.touristo.presentation.post_creation.root.store.PostCreationStoreFactory
import ru.inteam.touristo.presentation.post_creation.root.store.PostCreationUiEvent
import ru.inteam.touristo.presentation.post_creation.root.store.PostCreationUiEvent.Selected
import ru.inteam.touristo.view.post_creation.R
import ru.inteam.touristo.view.post_creation.databinding.PhotoSelectorFragmentBinding
import ru.inteam.touristo.view.post_creation.photo_selector.ui.mapper.PhotoSelectorRootUiStateMapper
import ru.inteam.touristo.view.post_creation.photo_selector.ui.mapper.PhotoSelectorUiStateMapper
...
import ru.inteam.touristo.view.post_creation.photo_selector.ui.recycler.decorations.PhotoSelectorItemDecoration
import ru.inteam.touristo.view.post_creation.photo_selector.ui.recycler.diff.PhotoSelectorDiffCallback
import ru.inteam.touristo.view.post_creation.photo_selector.ui.recycler.model.PhotoSelectorImageItem
import ru.inteam.touristo.view.post_creation.root.ui.PostCreationActivity.Companion.STORE_KEY
